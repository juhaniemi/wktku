...
(function() {
  ...
  Instafeed = (function() {
    ...
    Instafeed.prototype.runNext = function() {
      if (pagination.nextUrl) {
        return this.run(pagination.nextUrl);
      }
    };
    ...
    Instafeed.prototype.parse = function(response) {
      ...
      if (response.pagination && response.pagination.next_url) {
        pagination.nextUrl = response.pagination.next_url;
      } else {
        pagination.nextUrl = '';
      }
      ...
      if ((typeof document !== "undefined" && document !== null) && this.options.mock === false) {
        ...
        if ((this.options.template != null) && typeof this.options.template === 'string') {
          ...
          if (this.options.append === true) {
            htmlString = document.getElementById(this.options.target).innerHTML + htmlString;
          }
